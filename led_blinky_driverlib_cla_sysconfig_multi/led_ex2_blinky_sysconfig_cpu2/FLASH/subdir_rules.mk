...
build-1879382095: ../pinmux.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/sysconfig_1.20.0/sysconfig_cli.bat" -s "C:/ti/c2000/C2000Ware_5_02_00_00/.metadata/sdk.json" -d "F2838x" --script "C:/Users/User/Desktop/GitHub/GW/C2000/F28388D_DualCore_Timetask/led_blinky_driverlib_cla_sysconfig_multi/led_ex2_blinky_sysconfig_cpu1/pinmux.syscfg" --context "CPU1" --script "C:/Users/User/Desktop/GitHub/GW/C2000/F28388D_DualCore_Timetask/led_blinky_driverlib_cla_sysconfig_multi/led_ex2_blinky_sysconfig_cpu2/pinmux.syscfg" --context "CPU2" -o "syscfg" --compiler ccs
	@echo 'Finished building: "$<"'
	@echo ' '

syscfg/board.c: build-1879382095 ../pinmux.syscfg
syscfg/board.h: build-1879382095
syscfg/board.cmd.genlibs: build-1879382095
syscfg/board.opt: build-1879382095
syscfg/board.json: build-1879382095
syscfg/pinmux.csv: build-1879382095
syscfg/c2000ware_libraries.cmd.genlibs: build-1879382095
syscfg/c2000ware_libraries.opt: build-1879382095
syscfg/c2000ware_libraries.c: build-1879382095
syscfg/c2000ware_libraries.h: build-1879382095
syscfg/clocktree.h: build-1879382095
syscfg/: build-1879382095
